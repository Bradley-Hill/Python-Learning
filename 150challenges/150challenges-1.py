...
numberDiners = int(input("Please enter the number of people you will split the bill with: "))
...
print(numberDays, "days can be broken down into: ", numberHours, "Hours, ", numberMinutes, "Minutes and ", numberSeconds, "seconds.")
# Challenge 10
